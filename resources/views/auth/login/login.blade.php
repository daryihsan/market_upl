...
<body class="bg-white">
    <div class="flex h-screen">
        ...
        <div class="w-full lg:w-1/2 p-8 sm:p-16 flex flex-col justify-center">
            ...
            {{-- @if ($errors->any())
                <div class="rounded-xl bg-red-50 border border-red-200 text-red-800 px-4 py-3 mb-6">
            ...
            <p class="mt-8 text-center text-gray-500">
                Belum Punya Akun?
                <a href="{{ route('register.step1') }}" class="font-medium text-quad-light-blue hover:text-blue-700">
                    Daftar
                </a>
            </p>
