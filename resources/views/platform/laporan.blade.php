    ...
    <div class="flex min-h-screen">
        ...
        <main class="main-content">
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-blue-900">Dashboard
                        Laporan</h1>
                    ...
                    <div class="bg-white shadow px-6 py-4">
                        ...
                        <div class="flex justify-between items-start flex-wrap
                            ...
                            <form method="GET" action="{{ route('platform.laporan') }}"
                                ...
                                <button type="submit"
                                    class="bg-gray-100 text-gray-700 font-semibold py-2 px-4 rounded hover:bg-gray-200 transition">Terapkan</button>
                            </form>
                            ...
                            <table class="w-full">
                                ...
                                <thead class="bg-gray-50 border-b">
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[180px]">Nama
                                            User</th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[150px]">Nama
                                            PIC</th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[200px]">Nama
                                            Toko</th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[120px]">Status
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    @forelse($sellers as $seller)
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-gray-600">
                                                {{ str_pad(strstr($seller->email_pic, '@', true), 3, '0', STR_PAD_LEFT) }}
                                            </td>

                                            <td class="px-6 py-4 text-gray-800
                                                                                        font-medium">{{ $seller->nama_pic ?? '-' }}
                                            </td>
                            ...
                            <table class="w-full">
                                ...
                                <thead class="bg-gray-50 border-b">
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[150px]">
                                            Propinsi</th>
                                    </tr>
                                </thead>
                            ...
                            <table class="w-full">
                                ...
                                <thead class="bg-gray-50 border-b">
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[200px]">Produk
                                        </th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[100px]">
                                            Kategori</th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[120px]">Harga
                                        </th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[100px]">Rating
                                        </th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[150px]">Nama
                                            Toko</th>

                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[120px]">
                                            Propinsi</th>
                                    </tr>
                                </thead>
